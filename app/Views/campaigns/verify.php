...
<head>
    ...
    <title>التحقق من الرمز - حملات إيثار</title>
...
<body>
    <div class="container">
        <div class="card">
            ...
            <h1>تأكيد التسجيل</h1>
            <p class="description">أدخل رمز التحقق المكون من 4 أرقام المرسل إلى هاتفك لتأكيد حضورك للحملة</p>
            ...
            <form action="/campaigns/confirm" method="POST">
                <div class="form-group">
                    <input type="text" name="otp" class="otp-input" maxlength="4" pattern="\d{4}" placeholder="****" required autofocus>
                </div>

                <button type="submit" class="btn-submit">تأكيد التسجيل الآن</button>
            </form>

            <a href="/campaigns" class="back-link">← إلغاء والعودة</a>
        </div>
    </div>
